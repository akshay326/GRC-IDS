...
var C { i in 1..2, w in 0..W, a in actions, b in actions } = ( if i=1 then chi1[w,a,b]*sigma[2,w,b] else chi2[w,a,b]*sigma[1,w,a]  );
...
subject to nonnegative {i in 1..2, w in 0..W, a in actions} : 1>=sigma[i,w,a]>=0;
